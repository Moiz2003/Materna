  ...
  return (
    <section className="py-20 px-6 text-center">
      <FadeIn className="max-w-lg mx-auto">
        <h2 className="font-display text-3xl font-bold mb-3">Ready to see four AI agents review a case?</h2>
        ...
        <div className="flex gap-4 justify-center flex-wrap mb-2">
          ...
          <a href="/TECHNICAL_AUDIT.md" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 border border-border hover:border-teal-500/30 text-text-muted hover:text-teal-400 rounded-xl font-medium text-sm no-underline transition-all">
