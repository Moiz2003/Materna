    ...
    <div className="min-h-screen bg-bg-dark text-text">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <section className="mb-10 sm:mb-16">
          <h1 className="font-display text-3xl sm:text-4xl font-extrabold mb-4">About the Project</h1>
        ...
        {/* Team */}
        <section className="mb-10 sm:mb-16">
          <h2 className="font-display text-xl sm:text-2xl font-bold mb-4 sm:mb-6">The Team</h2>
        ...
        {/* Technology */}
        <section className="mb-10 sm:mb-16">
          <h2 className="font-display text-xl sm:text-2xl font-bold mb-4">Technology Stack</h2>
        ...
        {/* 8 Golden Rules */}
        <section>
          <h2 className="font-display text-xl sm:text-2xl font-bold mb-4 sm:mb-6">The 8 Golden Rules</h2>
      ...
      <footer className="border-t border-border py-6 sm:py-8 px-4 sm:px-6 text-center text-[11px] sm:text-xs text-text-subtle">
